...
# credhub set -t user -n /concourse/main/vcenter_user -z admin@vcenter.local -w "PASSWORD"
credhub set -t password -n /concourse/main/decryption-passphrase -w ''
...
credhub set -t password -n /concourse/main/awstest_ops_manager_iam_user_secret_key -w ''
credhub set -t value -n /concourse/main/awstest_rds_address -v ""
credhub set -t password -n /concourse/main/awstest_rds_password -w ''
